	...
	public function about_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						<h4>Bug Fixes and Maintenance</h4>
						<p>Minor bug fixes and updates</p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/3-1/" class="button"><?php _e( 'Check update log ', 'vibe' ); ?></a>
					</div>
					<div class="col-2">
						<h4>REST API Update</h4>
						<p>Rest API has been updated to work with fully functioning app. App available for download.</p>
						<a href="https://codecanyon.net/item/wplms-learning-management-system-app-for-education-elearning/20632362" class="button"><?php _e( 'Check WPLMS App', 'vibe' ); ?></a>
					</div>
				</div>
			</div>
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4>REST API</h4>
						<p><img src="<?php echo VIBE_URL; ?>/assets/images/wplms_3_0.png" /></p>
						<a href="http://vibethemes.com/documentation/wplms/article-categories/api-apps/" target="_blank" class="button">Tutorial</a>
					</div>
					<div>
						<h4>oAuth Server</h4>
						<p style="max-height: 230px; overflow: hidden;"><img src="<?php echo VIBE_URL; ?>/assets/images/oAuth-server.png" /></p>
						<a href="http://vibethemes.com/documentation/wplms/knowledge-base/wplms-oauth-server/" target="_blank" class="button">Tutorial</a>
					</div>
					<div class="last-feature">
						<h4>WPLMS Student App (iOS/Android)</h4>
						<p style="max-height: 230px; overflow: hidden;"><img src="<?php echo VIBE_URL; ?>/assets/images/app.jpg" /></p>
						<a href=" http://vibethemes.com/documentation/wplms/knowledge-base/wplms-student-app-introduction//" target="_blank" class="button">Tutorial</a>
					</div>
				</div>
